...
// Definimos las variables que quiero mandar a la base de datos
...
$sqlProveedorNew = "INSERT INTO proveedores_tb(nombre, cif, direccion, cp, provincia, poblacion, telefono, web, descripcion, id_servicio)
                        VALUES ('$nombre', '$cif', '$direccion', '', '', '', '$telefono', '', '', $servicio)";

//Ejecuto la consulta
$respuesta = mysqli_query($conn, $sqlProveedorNew);
